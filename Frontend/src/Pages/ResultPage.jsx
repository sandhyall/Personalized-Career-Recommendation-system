...
import { PlayCircle, FileText, ArrowLeft, Briefcase, GraduationCap, Wrench } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 mt-3 text-lg">Based on your unique skills and interests.</p>
        </div>
                  ...
                  <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                    ...
                    <div className="flex gap-1.5 flex-wrap">
                      {item.tools?.map((tool, i) => (
                        <span key={i} className="bg-white border border-slate-200 px-2.5 py-0.5 rounded-md text-xs font-semibold text-slate-600">
                          {tool}
                        </span>
                      ))}
                    </div>
